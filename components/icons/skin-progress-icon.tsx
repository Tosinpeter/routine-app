...
interface SkinProgressIconProps {
  size?: number;
  color?: string;
}

export function SkinProgressIcon({ size = 24, color = '#20201E' }: SkinProgressIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      />
      <Path
        d="M11.25 22C11.25 22.4142 11.5858 22.75 12 22.75C12.4142 22.75 12.75 22.4142 12.75 22L12 22L11.25 22ZM12 17L11.25 17L11.25 22L12 22L12.75 22L12.75 17L12 17Z"
        fill={color}
      />
      <Path
