...
import { CalendarPicker, DayItem, TimeSlot } from "@/features/lab-test/components/calendar-picker";
import { DistanceIcon } from "@/components/icons/distance-icon";
import { LocationIcon } from "@/components/icons/location-icon";
import { InfoItem } from "@/features/lab-test/components/info-item";
import { LabHeader } from "@/features/lab-test/components/lab-header";
...
export default function SelectLabTestScreen() {
  ...
  const handleSendRequest = () => {
    ...
    router.push('/lab-test/lab-test-completed');
  };
    ...
    <ThemedView style={styles.container}>
        ...
        >
          ...
          <View style={styles.content}>
            {/* Lab Info */}
            <Text style={styles.labName}>{t("labTest.demoLabName")}</Text>
            <Text style={styles.labDescription}>
              {t("labTest.demoLabDescription")}
            </Text>
