...
import { useTranslation } from "@/shared/store/hooks/use-app-data";
      ...
      <SafeAreaView style={styles.safeArea} edges={["top"]}>
        ...
        >
          <View style={styles.permissionsList}>
            <PermissionItem
              icon={<CameraIcon width={scale(24)} height={scale(24)} color={Colors.light.mainDarkColor} />}
            ...
            <PermissionItem
              icon={<GalleryIcon width={scale(24)} height={scale(24)} color={Colors.light.mainDarkColor} />}
            ...
            <View style={styles.divider} />
            <PermissionItem
              icon={<NotificationIcon width={scale(24)} height={scale(24)} color={Colors.light.mainDarkColor} />}
