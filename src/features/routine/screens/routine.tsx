...
import { RoutineStepShimmer } from "@/features/routine/components/routine-shimmer";
import { RoutineStepCard } from "@/features/routine/components/routine-step-card";
import { ThemedView } from "@/components/themed-view";
import { TimeToggleButton } from "@/features/routine/components/time-toggle-button";
...
import type { RoutineStep } from "@/shared/store/slices/home-slice";
import {
  setSelectedDay,
  setTimeOfDay,
...
export default function RoutineScreen() {
  ...
  const { selectedDay, timeOfDay, userName: storeUserName } = useAppSelector(
    (state) => state.home
  );
  ...
  const fetchRoutineData = async () => {
    try {
      ...
      const { data } = await client.get<RoutineData>(
        "/api/routine",
        { params: { day: selectedDay, timeOfDay } },
      );
