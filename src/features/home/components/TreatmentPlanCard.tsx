...
export function TreatmentPlanCard() {
    ...
    const title = homeData?.treatmentPlan?.title ?? t("home.treatmentPlan.defaultTitle");
    const subtitle = homeData?.treatmentPlan?.subtitle ?? t("home.treatmentPlan.defaultSubtitle");

    return (
        <View
            style={styles.container}
            accessible={true}
            accessibilityLabel={`${title}, ${current} out of ${total} ${t("home.treatmentPlan.completed")}`}
        ...
        >
            ...
            <View style={styles.textContainer}>
                ...
                <View style={styles.statusBadge}>
                    <Text style={styles.statusText}>{t("home.treatmentPlan.statusText", { current, total })}</Text>
                </View>
            </View>
        </View>
    );
