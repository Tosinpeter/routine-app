...
} from "@/shared/store/slices/payment-slice";
...
export default function CheckoutSummaryScreen() {
  ...
  const fullAddress = `${deliveryInfo.address}${deliveryInfo.apartment ? `, ${deliveryInfo.apartment}` : ""
...
const styles = StyleSheet.create({
  ...
  mastercardRed: {
    backgroundColor: Colors.light.paymentCardRed,
    start: 0,
  },
  mastercardOrange: {
    backgroundColor: Colors.light.paymentCardOrange,
    end: 0,
  },
  cardNumber: {
    ...AppTextStyle.bodyText1,
