...
import { setCheckoutDeliveryInfo } from "@/shared/store/slices/payment-slice";
      ...
      >
        ...
        >
            ...
            <View style={styles.logoContainer}>
              ...
              {formEmail ? (
                <View style={styles.emailMenuContainer}>
                  <Text style={styles.emailText}>{formEmail}</Text>
          ...
          <View style={styles.inputContainer}>
            <TextInput
              style={styles.textInput}
              placeholder={t("payment.delivery.county")}
              placeholderTextColor={Colors.light.grey500}
              value={county}
...
const styles = StyleSheet.create({
  ...
  logoDot: {
    ...
    backgroundColor: Colors.light.linkBlue,
    marginStart: scale(4),
  },
  emailMenuContainer: {
    flex: 1,
  ...
  checkbox: {
    ...
    borderWidth: 1.5,
    borderColor: Colors.light.borderD9,
    alignItems: "center",
