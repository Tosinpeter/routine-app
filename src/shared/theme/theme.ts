...
export const Colors = {
  light: {
    ...
    gradientBlue: "#A7CDFF",
    gradientGreenStart: "#D0F230",
    gradientGreenEnd: "#32D583",
    gradientOrangeStart: "#FDA29B",
    // Accent colors
    accentPurple: "#7C3AED",
    // Shadow colors
    ...
    // UI / semantic (no hardcoded colors in components)
    warmOffWhite: "rgba(245, 241, 238, 1)",
    warmOffWhiteAlt: "#F5F1EE",
    gradientPeach: "#F7D5B7",
    paymentCardRed: "#EB001B",
    paymentCardOrange: "#FF5F00",
    borderLight: "rgba(235, 235, 235, 1)",
    orderTrackingPink: "#F4D7E4",
    primaryAlpha20: "rgba(207, 96, 74, 0.2)",
    primaryAlpha10: "rgba(207, 96, 74, 0.1)",
    overlayDark: "rgba(84, 84, 86, 0.34)",
    mainDarkAlpha12: "rgba(32, 32, 30, 0.12)",
    mainDarkAlpha16: "rgba(32, 32, 30, 0.16)",
    successIconGreen: "#2ECC71",
    successGreen: "#077C46",
    warmLightBg: "rgba(246, 240, 238, 1)",
    ...
    blackAlpha38: "rgba(0, 0, 0, 0.38)",
    blackAlpha60: "rgba(0, 0, 0, 0.6)",
    overlay: "rgba(0, 0, 0, 0.5)",
    greyMid: "#666666",
    grey248: "rgba(248, 248, 248, 1)",
    grey99: "rgba(153, 153, 153, 1)",
    greyOverlay: "rgba(118, 115, 115, 0.16)",
    borderD9: "rgba(217, 217, 217, 1)",
    borderCCC: "#CCCCCC",
    linkBlue: "#4F8FF7",
    brownText: "rgba(70, 26, 4, 1)",
    cardShadow: "rgba(37, 62, 111, 0.08)",
    nearWhite: "#FCFCFD",
    scaffoldAlpha08: "rgba(237, 235, 227, 0.08)",
    sage: "#7B988A",
    borderF3: "rgba(243, 242, 242, 0.25)",
    infoBlue: "#3736FD",
    mainDarkAlt: "#1C1B1F",
    errorRed: "#F41D12",
    error: "#F04438",
    errorRgba: "rgba(240, 68, 56, 1)",
    destructive: "#DC2626",
    navDark: "#161B26",
    warning: "#F79009",
    warningLightBg: "#FEF0C7",
    errorLightBg: "#FEF3F2",
    errorBorder: "#FECDCA",
    accentPurpleLight: "#F4F3FF",
    successIconLight: "#D1FADF",
    notificationBg: "#F3EDE7",
  },
  dark: {
    text: "#11181C",
    white: "#fff",
    ...
    dermatologistBadgeBg: "rgba(237, 125, 26, 0.1)",
    dermatologistBadgeText: "#632F00",
    // UI / semantic (mirror light for dark mode)
    warmOffWhite: "rgba(245, 241, 238, 1)",
    warmOffWhiteAlt: "#F5F1EE",
    gradientPeach: "#F7D5B7",
    paymentCardRed: "#EB001B",
