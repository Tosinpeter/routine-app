            ...
            <SafeAreaView edges={['top', 'left', 'right']} style={[styles.safeArea]}>
                ...
                >
                    ...
                    <View style={styles.warningContainer}>
                        <WarningIcon size={24} color="#F79009" />
                        <Text style={styles.warningMessage}>
                            Make sure to <Text style={styles.warningBold}>Present</Text> this prescription to{"\n"}
                            the <Text style={styles.warningBold}>Pharmacist</Text> as-is, without any edits.
                        </Text>
                    </View>
                </ScrollView>
            </SafeAreaView>
